...
Python 3.8+
pip
Una API key gratuita de NewsAPI.org
📦 Instalación
...
🚀 Uso
Intro: Al cargar la página aparece el globo en vista lejana con un punto pulsante. Haz clic para iniciar el zoom de entrada.
Zoom de entrada: La cámara hace un zoom fluido hacia el globo (animado con GSAP).
Paneles: Al finalizar el zoom, aparecen con animación los paneles NEWS_TERMINAL y CONSOLE.
Seleccionar país: Haz clic sobre cualquier país en el globo para cargar sus noticias.
Leer noticia: Haz clic sobre un titular para ver el resumen y el enlace a la fuente.
Resetear: Usa el botón RESET_CAMERA para volver a la vista global.
